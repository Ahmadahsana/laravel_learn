        ...
        <div class="container-fluid w-full flex flex-wrap items-center justify-between px-6">
            <div class="container-fluid">
                <a class="flex items-center text-gray-900 hover:text-gray-900 focus:text-gray-900 mt-2 lg:mt-0 mr-1"
                    href="#">
                    <img src="img/pura it service.svg" style="height: 20px" alt="" loading="lazy" />
                    <span class="font-medium ml-4">Admin Page</span>
                </a>
            </div>
        </div>
        </nav> --}}
        <div class="w-60 h-full shadow-md bg-white px-1 absolute pt-3 rounded-lg">
        <ul class="relative">
